  ...
  const folderInfo: Record<SimpleSlug, ProcessedContent> = Object.fromEntries(
    [...folders].map((folder) => [
      ...
      defaultProcessedContent({
        ...
        frontmatter: {
          // Nome da propria pasta em vez de "Pasta: Calculo-2/Provas". Vale para
          // o <title> da aba e para o indice de busca, nao so para o cabecalho.
          title: (folder.split("/").pop() ?? folder).replace(/[-_]+/g, " "),
          tags: [],
        },
      }),
    ]),
